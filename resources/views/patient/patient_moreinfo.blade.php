                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control form-control-sm update-field" name="category">
                                                    ...
                                                    <option value="1" data-column-id="{{ $patients->id }}" data-column-name="category" @if($patients->category == "1") selected @endif>Student</option>
                                    ...
                                    <div class="form-group mtop">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="studCourse" class="form-control form-control-sm update-field select2" data-column-id="{{ $patients->id }}" data-column-name="studCourse" id="courseSelect">
